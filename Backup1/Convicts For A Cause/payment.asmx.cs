...
namespace Convicts_For_A_Cause
{
    ...
    public class payment : System.Web.Services.WebService
    {
       // private ConvictsContext db = new ConvictsContext();
        ...
        {
            PaymentDTO paymentresults = paymentsHelper.AddPayment(senderEmail, receipentEmail, amount, "", "team donation");
        ...
        {
            PaymentDTO paymentresults = paymentsHelper.AddPayment(senderEmail, receipentEmail, amount, "", "general donation");
        ...
        {
            PaymentDTO paymentresults = paymentsHelper.AddPayment(senderEmail, receipentEmail, amount, message, paymentType);
